...
object CycleEngine {
    ...
    fun calculatePastCycles(
        ...
        transactions: List<Transaction>,
        today: LocalDate
    ): List<com.dvide.app.domain.model.PastCycle> {
        ...
        val pastCycles = mutableListOf<com.dvide.app.domain.model.PastCycle>()
        ...
        while (!checkDate.isBefore(earliestDate)) {
            ...
            pastCycles.add(com.dvide.app.domain.model.PastCycle(monthLabel, rangeLabel, m.balance))
